-- audit_trigger_func: records INSERT/UPDATE activity into audit.audit_log (schema-qualified).
-- NOTE: CREATE TRIGGER below depends on public.users existing — run db:sample:migrate first.
